...
def run():
    ...
    for current_row in current_df.itertuples(index=False):
        ...
        _fetch_and_save_stock_history_bfq(
            stock_code=stock_code, start_date=start_date, end_date=date_string
        )
        _fetch_and_save_stock_history_qfq(
            stock_code=stock_code, start_date=start_date, end_date=date_string
        )
        # _fetch_and_save_stock_history_hfq(
        #     stock_code=stock_code, start_date=start_date, end_date=date_string
        # )
        print(f"done stock_code: {stock_code}")
...
# ):
def _fetch_and_save_stock_history_bfq(stock_code, start_date, end_date):
...
def _fetch_and_save_stock_history_qfq(stock_code, start_date, end_date):
    history_df = ak.stock_zh_a_hist(
        symbol=stock_code,
        period="daily",
        start_date=start_date,
...
# def _fetch_and_save_stock_history_hfq(stock_code, start_date, end_date):
#     history_df = ak.stock_zh_a_hist(
#         symbol=stock_code,
#         period="daily",
#         start_date=start_date,

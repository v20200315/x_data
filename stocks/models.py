...
class RealTimeStock(models.Model):
    ...
    highest_price = models.FloatField(verbose_name="最高")
    lowest_price = models.FloatField(verbose_name="最低")
    today_opening_price = models.FloatField(verbose_name="今开")
    yesterday_closing_price = models.FloatField(verbose_name="昨收")
